...
func Setup(ctx *app.App) {
	...
	if ctx.Config.MapObjects.Signs {
		...
		// Mineclonia legacy
		l.AddMapObject("mcl_signs:wall_sign", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_sprucewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_sprucewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_sprucewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_sprucewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_sprucewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_darkwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_darkwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_darkwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_darkwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_darkwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_junglewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_junglewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_junglewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_junglewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_junglewood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_acaciawood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_acaciawood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_acaciawood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_acaciawood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_acaciawood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_mangrove_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_mangrove_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_mangrove_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_mangrove_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_mangrove_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_warped_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_warped_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_warped_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_warped_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_warped_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_crimson_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_crimson_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_crimson_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_crimson_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_crimson_hyphae_wood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_bamboo", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_bamboo", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_bamboo", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_bamboo", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_bamboo", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_birchwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_birchwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_birchwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_birchwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_birchwood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:wall_sign_cherrywood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign_cherrywood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign22_5_cherrywood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign45_cherrywood", &MclSignBlock{Material: "wood"})
		l.AddMapObject("mcl_signs:standing_sign67_5_cherrywood", &MclSignBlock{Material: "wood"})
		// Mineclonia current
		prefix := "mcl_signs:"
		materials := []string{
		...
		for _, t := range types {
			for _, m := range materials {
				...
				l.AddMapObject(blockName, &MclSignBlock{Material: "wood"})
			}
		}
	}
